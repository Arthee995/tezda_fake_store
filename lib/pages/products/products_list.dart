            ...
            () => ListView.builder(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                    onTap: () {
                      productController
                          .fetchProductDetailAPI(id: productController.products.value[index].id)
                          .then((value) {
                    ...
                    child: Card(
                      child: ListTile(
                        leading: Image.network(productController.products.value[index].image.toString(),width: 50,height: 50,),
                        title: Text(productController.products.value[index].title ?? ''),
                        subtitle: Text("Price: ${productController.products.value[index].price.toString()}"),
                        // trailing: IconButton(
                        //   onPressed: () {
                        ...
                        //   },
                        //   icon: Obx(() =>
                        //       Icon(productController.selectFav.value == true ? Icons.favorite : Icons.favorite_border)),
                        // ),
                      ),
                    ));
              },
